...
const KEYWORD_RULES: Array<[string[], string]> = [
  ...
  [['chorizo', 'salchicha', 'salame', 'salami', 'sausage', 'embutido', 'morcilla'], 'tabler:sausage'],
  [['camaron', 'gamba', 'langostino', 'shrimp', 'prawn', 'marisco', 'seafood', 'pulpo', 'calamar'], 'lucide:shrimp'],
  ...
  [['poroto', 'frijol', 'lenteja', 'garbanzo', 'legumbre', 'bean', 'lentil', 'chickpea', 'edamame'], 'lucide:bean'],
  [['nuez', 'nueces', 'almendra', 'mani', 'cacahuate', 'peanut', 'almond', 'cashew', 'pistacho', 'avellana', 'frutos secos', 'nut'], 'tabler:nut'],
  [['tofu', 'soja', 'soya', 'soy', 'vegano', 'vegan', 'seitan'], 'lucide:vegan'],
  [['milanesa', 'carne', 'res', 'vacuna', 'bife', 'lomo', 'asado', 'beef', 'steak', 'molida', 'picada'], 'tabler:meat'],
  ...
  [['proteina', 'protein', 'whey', 'caseina', 'creatina', 'creatine', 'bcaa', 'pre workout', 'preworkout', 'suplemento', 'supplement', 'gainer'], 'tabler:barbell'],
  ...
  [['avena', 'oat', 'granola', 'muesli', 'cereal', 'grano', 'grain', 'maiz', 'choclo'], 'tabler:grain'],
  ...
  [['cereza', 'guinda', 'cherry', 'frutilla', 'strawberry', 'arandano', 'blueberry', 'frambuesa', 'berries', 'berry'], 'tabler:cherry'],
  [['limon', 'lima', 'naranja', 'mandarina', 'pomelo', 'lemon', 'lime', 'orange', 'citrico', 'citrus'], 'tabler:lemon'],
  ...
  [['verdura', 'vegetal', 'brocoli', 'espinaca', 'lechuga', 'kale', 'acelga', 'vegetable', 'spinach', 'lettuce'], 'tabler:salad'],
  ...
  [['torta', 'pastel', 'tarta', 'budin', 'bizcocho', 'cake', 'brownie', 'muffin', 'magdalena'], 'tabler:cake'],
  [['flan', 'postre', 'pudding', 'mousse', 'dessert', 'gelatina'], 'lucide:dessert'],
  [['caramelo', 'golosina', 'gomita', 'gummy', 'candy', 'azucar', 'sugar', 'miel', 'honey', 'mermelada', 'jam', 'dulce de leche'], 'tabler:candy'],

  // --- drinks --- (coffee handled in overrides above)
  [['mate', 'te', 'tea', 'infusion'], 'tabler:teapot'],
  [['agua', 'water'], 'lucide:glass-water'],
  [['gaseosa', 'refresco', 'soda', 'cola', 'coca', 'sprite', 'fanta', 'jugo', 'zumo', 'juice', 'energy', 'isotonic', 'gatorade'], 'lucide:cup-soda'],
  ...
  [['trago', 'coctel', 'cocktail', 'margarita', 'mojito', 'daiquiri', 'caipirinha'], 'tabler:glass-cocktail'],
  [['gin', 'vodka', 'whisky', 'whiskey', 'ron', 'rum', 'tequila', 'fernet', 'aperitivo', 'licor', 'liquor', 'aperol'], 'tabler:glass-gin'],
  [['batido', 'licuado', 'smoothie', 'shake', 'milkshake'], 'tabler:milkshake'],
  [['bubble tea', 'boba'], 'tabler:bubble-tea'],

  // --- condiments / cooking ---
  [['aceite', 'oliva', 'oil', 'vinagre', 'vinegar', 'aderezo', 'dressing', 'mayonesa', 'mayo', 'ketchup', 'mostaza', 'mustard', 'salsa', 'sauce'], 'tabler:bottle'],
