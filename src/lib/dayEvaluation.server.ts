...
function buildSystemPrompt(tone: EvalTone): string {
  return [
    ...
    '   Good: "breakfast was strong but nothing filled the afternoon gap."',
    '   Bad: "bring back the sweet potato quinoa bowl."',
    '3. Give an honest verdict. Name the ROOT CAUSE: what structurally went wrong',
    '   (skipped a meal slot, no afternoon food, front-loaded all calories, etc.).',
    '4. The recommendation should be structural: "repeat the structure of your',
    '   stronger days" or "add a complete afternoon meal" — not a recipe.',
