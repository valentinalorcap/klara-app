...
function buildSystemPrompt(tone: EvalTone): string {
  return [
    ...
    '3. Give an honest verdict. Name the ROOT CAUSE as a BEHAVIOR, not a macro:',
    ...
    '4. The recommendation should name a meal slot or habit, not a nutrient:',
    '   "add a complete afternoon meal" not "increase your protein intake".',
