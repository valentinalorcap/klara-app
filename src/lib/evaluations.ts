...
export function buildSystemPrompt(tone: EvalTone): string {
  return [
    ...
    '3. The Day status tags (OVER / UNDER / ON-TRACK / UNSET) tell you what to',
    '   address. Mention the gap qualitatively, not by repeating the exact numbers.',
    '   Never suggest more of an OVER macro. Never mention an UNSET macro.',
    '4. Focus on what matters RIGHT NOW: what should they eat next, or what',
    '   pattern are you seeing across the week?',
    '',
    TONE_GUIDANCE[tone],
    '',
