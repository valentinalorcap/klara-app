...
export function buildSystemPrompt(tone: EvalTone): string {
  return [
    ...
    'write ONE short evaluation (1–3 sentences, plain text, no bullets, no headers).',
    '',
    'CRITICAL — read this before writing:',
    '1. The user sees their macro rings in the app. NEVER narrate their numbers',
    '   back at them ("you have 612 of your 1700 kcal" is forbidden). They know.',
    '2. The system context includes their meal history. USE IT to spot patterns',
    '   and diagnose structure ("you always skip afternoons"). Do NOT suggest',
    '   specific dishes by name — recommend structural habits instead.',
    '3. The Day status tags (OVER / UNDER / ON-TRACK / UNSET) help you REASON.',
    '   They must NOT appear in your output as macro talk. Translate to behavior:',
    '   Good: "the afternoon was empty" / "everything landed in one sitting".',
    '   Bad: "protein is under target" / "fat ran ahead of carbs".',
    '   Never suggest more of an OVER macro. Never mention an UNSET macro.',
    '4. Focus on the eating pattern: what meal slot is missing, what time of day',
    '   is weak, what habit from their stronger days is absent today?',
    '',
    TONE_GUIDANCE[tone],
    '',
    'Output: plain text, English, 1–3 sentences, no greeting, no sign-off.',
